...
class Signup extends Component {
  ...
  _search = () => {
    ...
    axios
      .post('https://placetracker.net/RestAPIs/friendSearchRequest', data)
      .then(res => {
        if (res.data.status) {
  ...
  _addFriend = item => {
    ...
    axios
      .post('https://placetracker.net/RestAPIs/friendAddRequest', data)
      .then(res => {
        this.setState({loading: false});
        if (res.data.status) {
      ...
      <ImageBackground source={backImage} style={styles.backgroundImage}>
        <ScrollView
          ...
          <TouchableOpacity
            ...
            <Image source={addFriend} style={styles.iconImage} />
